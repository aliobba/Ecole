...
public class AdapterClasseAbsence extends RecyclerView.Adapter<AdapterClasseAbsence.MyViewHolder> {
    ...
    public AdapterClasseAbsence(@NonNull Context context, List<Classe> classe) {
    ...
    @NonNull
    @Override
    public AdapterClasseAbsence.MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = inflater.inflate(R.layout.classe_enseignant_item, viewGroup, false);
        AdapterClasseAbsence.MyViewHolder holder = new AdapterClasseAbsence.MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterClasseAbsence.MyViewHolder myViewHolder, int position) {
        ...
        myViewHolder.eleve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mFragment = new ListeElevesAbsents();
