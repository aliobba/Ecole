...
public class ClasseAbsence extends Fragment {

    AdapterClasseAbsence adapter;
    SwipeRefreshLayout refresh;
    RecyclerView rv_liste;
    ArrayList<Classe> classe;
    String url = "http://"+ UserLoged.url+"/MonEcole-web/rest/classe/findClasseByEnseignant/";

    public ClasseAbsence() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adapter = new AdapterClasseAbsence(getActivity(),classe);
