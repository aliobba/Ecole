...
public class ListeEnfantCahier extends Fragment {

    AdapterCahierEleve adapter;
    ArrayList<Eleve> eleve;
    SwipeRefreshLayout refresh;
    RecyclerView rv_liste;
    String url = "http://"+ UserLoged.url+"/findEleveByParent/";

    public ListeEnfantCahier() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.activity_liste_enfant_cahier, container, false);
        ...
        eleve=new ArrayList<>();
        adapter = new AdapterCahierEleve(getActivity(),eleve);
